(function(angular) {
  ...
  angular
    ...
    .controller("compareController", function(
      ...
      vm.noDay = $stateParams.kind == 'yearly' || $stateParams.kind == 'monthly' ? true : false;

      let {dddate1, dddate2, dddate3} = compareService.getInitialDateObjects($stateParams.kind);
      vm.date1 = dddate1;
      vm.date2 = dddate2;
      vm.date3 = dddate3;
      ...
      let setDates = (dat1, dat2, dat3) => {
        ...
        let {ddate1, ddate2, ddate3} = compareService.setCustomDateObjects($stateParams.kind, date1, date2, date3);
